...
public abstract class BaseTitleBarActivity extends BaseActivity {
    ...
    private void initTitleLayout() {
        ...
        mTitleView = (TextView) findViewById(R.id.base_tv_title);
        mBackView = (ImageView) findViewById(R.id.base_iv_back);
        ...
        mIvRight = (ImageView) findViewById(R.id.base_iv_right);
